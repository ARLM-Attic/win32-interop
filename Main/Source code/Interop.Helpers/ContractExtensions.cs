...
// ReSharper restore CheckNamespace
{
    ...
    internal sealed class ContractOptionAttribute : Attribute
    {
        ...
        public ContractOptionAttribute([NotNull] string category, [NotNull] string setting, bool toggle)
        {
        }
        ...
        public ContractOptionAttribute([NotNull] string category, [NotNull] string setting, [NotNull] string value)
        {
        }
    }
}